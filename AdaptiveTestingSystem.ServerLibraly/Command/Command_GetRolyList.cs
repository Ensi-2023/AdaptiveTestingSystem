...
{
    public class Command_GetRolyList:Commands
    {
        ...
        {
            sendPacket = new ThreadSendPacket("Command_SetUserRoly", client, activeServer);

            var listEmployee = await DBDataMethod.GetRolyList();
