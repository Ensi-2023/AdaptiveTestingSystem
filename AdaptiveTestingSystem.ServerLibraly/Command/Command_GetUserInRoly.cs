...
{
    public class Command_GetUserInRoly:Commands
    {
        ...
        {
            sendPacket = new ThreadSendPacket("Command_SetRolyInformationList", client, activeServer);

            var listEmployee = await DBDataMethod.GetRolyInformationList(obj.Index);
